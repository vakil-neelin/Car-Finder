...
chromedriver_location = r'C:\Users\MRET229\Downloads\chromedriver.exe'
...
try:
    ...
    elem = WebDriverWait(driver, 300).until(
        EC.element_to_be_clickable((By.XPATH, '//*[@id="navContainerCollapse"]/div/ul/li[2]/a/div[1]')))
    sleep(1)
    elem.click()
except:
...
WebDriverWait(driver, 240).until(
    EC.invisibility_of_element_located((By.ID, 'noSearch')))
sleep(.5)
